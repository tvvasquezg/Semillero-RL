...
class Visualizer:
    ...
    def load_data(self):
        self.img = pygame.image.load('C:\\Users\\mateo\\Downloads\\spritesheet.png').convert()
        self.robot = pygame.image.load('C:\\Users\\mateo\\Downloads\\robot.png').convert_alpha()
...
def render(alpha,epsilon,timesteps):
    ...
    total_rewards = 0
    img = pygame.image.load('C:\\Users\\mateo\\Downloads\\spritesheet.png').convert()
    robot = pygame.image.load('C:\\Users\\mateo\\Downloads\\robot.png').convert_alpha()
